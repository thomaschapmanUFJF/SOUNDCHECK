...
public class Sala implements Savable {
    ...
    public void setInfo(String numero, int capacidade, float valor, boolean disponivel) {
        setNumero(numero);
    ...
    @Override
    public String getArquivo() { return "data/salas.txt"; }

    @Override
    public String toLinha() {
        return String.join(";", numero, String.valueOf(capacidade), String.valueOf(valor), String.valueOf(disponivel));
    }
    ...
    public boolean equals(Object obj){
        ...
        Sala outra = (Sala) obj;
        return this.numero.equalsIgnoreCase(outra.numero);
    }
    @Override
    public int hashCode() {
        return java.util.Objects.hash(numero.toLowerCase());
    }
}